...
def main(input_question):
    ...
    return {'question': input_question, 'answer': result, 'hop1': two_hops_results[0]['hop1_query'], 'hop2': two_hops_results[0]['hop2_query'], 'hop1_document': two_hops_results[0]['context'][0][1][0], 'hop2_document': two_hops_results[0]['context'][5][1][0]}
